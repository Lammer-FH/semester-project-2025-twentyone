      ...
      <template v-if="player">
        ...
        <div class="ion-padding">
          <template v-if="!isEditing">
            <ion-button expand="block" @click="startEditing"> Edit Profile </ion-button>
          </template>
          <template v-else>
            <ion-button expand="block" @click="handleUpdate"> Save Changes </ion-button>
            <ion-button expand="block" fill="outline" @click="cancelEditing"> Cancel </ion-button>
          </template>
